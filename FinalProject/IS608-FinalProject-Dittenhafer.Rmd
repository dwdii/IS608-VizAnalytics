...
if(doBirthRateCombine)
{
  ...
  udbc <- mutate(udbc, BirthsPer100Pop=Births / CENSUS2010POPHundreds)  
  udbc <- mutate(udbc, BirthsPer1000Pop=Births / CENSUS2010POPThousands)
  ...
  if(bSave)
  {
    ...
    write.table(udbcLimited, dataFile,sep=",", row.names=FALSE)  
  }  
}
```
