...
g1 <- g1 + labs(title="United States Births 2003 - 2012",
                x="Time",
                y="Births")
g1
```
...
```{r births_w_model, echo=FALSE, fig.cap="U.S. Births 2003-2012 with Linear Regression & UnemploymentRate & Model", fig.path='figure/'}
